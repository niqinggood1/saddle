...
if __name__ == "__main__":
    ...
    keywords = keywords_extraction(text)            # 关键词抽取
    print(keywords)

    keyphrases = keyphrases_extraction(text)        # 关键短语抽取
    print(keyphrases)

    keysentences = keysentences_extraction(text)    # 关键句抽取
    print(keysentences)
